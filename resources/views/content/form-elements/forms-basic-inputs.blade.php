        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-4">
                    ...
                    <select class="form-select select2" id="exampleFormControlSelect1" aria-label="Default select example">
                ...
                <div class="mb-4">
                    ...
                    <select multiple class="form-select select2" id="exampleFormControlSelect2" aria-label="Multiple select example">
                        <option selected>Open this select menu</option>
                        <option value="1">One</option>
                        <option value="2">Two</option>
                        <option value="3">Three</option>
                ...
                <div class="mb-4">
                    ...
                    <select class="form-select select2" id="exampleFormControlSelect3" size="2" aria-label="Size 2 select example">
                        <option selected>Open this select menu</option>
                        <option value="1">One</option>
                        <option value="2">Two</option>
                        <option value="3">Three</option>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mt-2 mb-4">
                    ...
                    <select id="largeSelect" class="form-select form-select-lg select2">
                ...
                <div class="mb-4">
                    ...
                    <select id="defaultSelect" class="form-select select2">
                ...
                <div>
                    ...
                    <select id="smallSelect" class="form-select form-select-sm select2">
