...
<head>
    ...
    <title>@yield('title', 'Bassani Motorista')</title>
...
<body>
    ...
    <nav class="bottom-nav">
        <a href="{{ url('/driver/home') }}" class="nav-item {{ request()->is('driver/home') ? 'active' : '' }}">
            <i class="bx bx-home"></i>
            <span>Início</span>
        </a>
        <a href="{{ url('/driver/my-schedule') }}" class="nav-item {{ request()->is('driver/my-schedule') ? 'active' : '' }}">
            <i class="bx bx-calendar"></i>
            <span>Entregas</span>
        </a>
        <a href="{{ url('/driver/home') }}" class="nav-item nav-home {{ request()->is('driver/home*') ? 'active' : '' }}">
            <i class="bx bx-plus"></i>
        </a>
        <a href="{{ url('/driver/expenses') }}" class="nav-item {{ request()->is('driver/expenses*') ? 'active' : '' }}">
            <i class="bx bx-receipt"></i>
            <span>Despesas</span>
        </a>
        <a href="{{ url('/driver/profile') }}" class="nav-item {{ request()->is('driver/profile') ? 'active' : '' }}">
