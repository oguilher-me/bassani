...
@section('title', __('Cadastro de Clientes'))
    ...
    <div class="col-xl"> 
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">{{ __('Cadastro de Clientes') }}</h5>
            </div> 
            <div class="card-body">
                <form action="{{ route('customers.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-3">
                            ...
                            <select class="form-select select2" id="customer_type" name="customer_type" required>
                                ...
                                <option value="PF" {{ old('customer_type') == 'PF' ? 'selected' : '' }}>{{ __('Pessoa Física') }}</option>
                                <option value="PJ" {{ old('customer_type') == 'PJ' ? 'selected' : '' }}>{{ __('Pessoa Jurídica') }}</option>
                            </select>
                            @error('customer_type')
                    ...
                    <div class="row" id="pf_fields" style="display: {{ old('customer_type') == 'PF' ? 'flex' : 'none' }};">
                    ...
                    <div class="row" id="pj_fields" style="display: {{ old('customer_type') == 'PJ' ? 'flex' : 'none' }};">
                        <div class="mb-3 col-md-6">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control cnpj" id="cnpj" name="cnpj" value="{{ old('cnpj') }}" maxlength="18">
                            @error('cnpj')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-2">
                            ...
                            <input type="text" class="form-control" id="address_number" name="address_number" value="{{ old('address_number') }}" required>
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="text" class="form-control" id="address_neighborhood" name="address_neighborhood" value="{{ old('address_neighborhood') }}" required>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-2">
                            ...
                            <input type="text" class="form-control" id="address_state" name="address_state" value="{{ old('address_state') }}" maxlength="2" required>
                            @error('address_state')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="text" class="form-control" id="address_zip_code" name="address_zip_code" value="{{ old('address_zip_code') }}" required>
