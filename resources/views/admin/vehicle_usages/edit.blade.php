    ...
    <div class="col-xl">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">{{ __('Editar Uso de Veículo') }}</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('vehicle_usages.update', $vehicleUsage->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <select class="form-select select2" id="vehicle_id" name="vehicle_id" required disabled>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="number" class="form-control" id="departure_mileage" name="departure_mileage" value="{{ old('departure_mileage', $vehicleUsage->departure_mileage) }}" required>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="number" class="form-control" id="return_mileage" name="return_mileage" value="{{ old('return_mileage', $vehicleUsage->return_mileage) }}">
