    ...
    <div class="col-xl">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">{{ __('Editar Veículo') }}</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('vehicles.update', $vehicle->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" id="placa" name="placa" value="{{ old('placa', $vehicle->placa) }}" required>
                            @error('placa')
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="number" class="form-control" id="ano_fabricacao" name="ano_fabricacao" value="{{ old('ano_fabricacao', $vehicle->ano_fabricacao) }}" required>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="number" class="form-control" id="quilometragem_atual" name="quilometragem_atual" value="{{ old('quilometragem_atual', $vehicle->quilometragem_atual) }}" required>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="number" step="0.01" min="0" class="form-control"
                                   ...
                                   value="{{ old('cubic_capacity', $vehicle->cubic_capacity) }}"
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select class="form-select" id="status" name="status" required>
                                <option value="Ativo" {{ old('status', $vehicle->status) == 'Ativo' ? 'selected' : '' }}>Ativo</option>
                                <option value="Em manutenção" {{ old('status', $vehicle->status) == 'Em manutenção' ? 'selected' : '' }}>Em manutenção</option>
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <textarea class="form-control" id="observacoes" name="observacoes" rows="3">{{ old('observacoes', $vehicle->observacoes) }}</textarea>
                            @error('observacoes')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
