...
@section('title', __('Novo Veículo'))

@section('content')
{{-- Page Header --}}
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold mb-1">{{ __('Novo Veículo') }}</h4>
        <p class="text-muted mb-0">{{ __('Cadastro de novo veículo na frota') }}</p>
    </div>
                ...
                <form action="{{ route('vehicles.store') }}" method="POST">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" id="placa" name="placa" value="{{ old('placa') }}" required style="text-transform: uppercase;">
                            @error('placa')
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control" id="ano_fabricacao" name="ano_fabricacao" value="{{ old('ano_fabricacao') }}" required min="1900" max="{{ date('Y') + 1 }}">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" id="quilometragem_atual" name="quilometragem_atual" value="{{ old('quilometragem_atual') }}" required min="0">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.01" min="0" class="form-control" id="cubic_capacity" name="cubic_capacity" value="{{ old('cubic_capacity') }}" placeholder="0.00">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-select" id="status" name="status" required>
                                ...
                                <option value="Em manutenção" {{ old('status') == 'Em manutenção' ? 'selected' : '' }}>{{ __('Em manutenção') }}</option>
                    ...
                    <div class="d-flex justify-content-end gap-2 pt-3 border-top">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bx bx-check me-1"></i> {{ __('Salvar Veículo') }}
                        </button>
                    </div>
                </form>
            </div>
