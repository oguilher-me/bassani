...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold mb-1">{{ __('Cadastro de Fornecedores') }}</h4>
        <p class="text-muted mb-0">{{ __('Cadastrar novo fornecedor ou parceiro') }}</p>
    </div>
                ...
                <form action="{{ route('suppliers.store') }}" method="POST">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-8">
                            ...
                            <textarea class="form-control" id="services_offered" name="services_offered" rows="2" placeholder="Descreva os serviços ou produtos oferecidos...">{{ old('services_offered') }}</textarea>
                    ...
                    <div class="d-flex justify-content-end gap-2 pt-3 border-top">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bx bx-check me-1"></i> {{ __('Salvar Fornecedor') }}
                        </button>
                    </div>
                </form>
            </div>
