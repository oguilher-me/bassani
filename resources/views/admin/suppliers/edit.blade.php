    ...
    <div class="col-xl">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">{{ __('Editar Fornecedor') }}</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('suppliers.update', $supplier->id) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <textarea class="form-control" id="services_offered" name="services_offered">{{ old('services_offered', $supplier->services_offered) }}</textarea>
