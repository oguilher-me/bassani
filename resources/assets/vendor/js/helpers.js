...
const Helpers = {
  ...
  _setCollapsed(collapsed) {
    ...
    if (collapsed) {
      this._addClass('layout-menu-collapsed', layoutMenu);
      this._removeClass('layout-menu-expanded', layoutMenu);
    } else {
      this._removeClass('layout-menu-collapsed', layoutMenu);
      this._addClass('layout-menu-expanded', layoutMenu);
    }
  },
